...
public class JadwalUjianAdapter extends RecyclerView.Adapter<JadwalUjianAdapter.JadwalHolder>{
    ...
    public JadwalUjianAdapter(ArrayList<ExamSchedule> list){
    ...
    @Override
    public void onBindViewHolder(@NonNull JadwalHolder holder, int position) {
